...
>
  ...
  <div className="mx-auto grid max-w-6xl items-center gap-16 px-6 lg:grid-cols-2">
    ...
    <div className="relative isolate">
      ...
      <div className="absolute bottom-3 -right-12 z-30 hidden origin-bottom-right scale-[0.8] rounded-3xl border border-border bg-background p-5 shadow-2xl xl:block">
