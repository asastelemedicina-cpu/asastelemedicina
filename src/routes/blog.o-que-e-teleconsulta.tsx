...
const CANONICAL = "https://www.asastelemedicina.com.br/blog/o-que-e-teleconsulta";
...
export const Route = createFileRoute("/blog/o-que-e-teleconsulta")({
  head: () => ({
    meta: [
      { title: TITLE },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "Blog",
              item: "https://www.asastelemedicina.com.br/blog",
            },
            {
              "@type": "ListItem",
              position: 3,
        ...
        <div className="prose-content mt-12 space-y-6 text-base leading-relaxed text-foreground/90">
          ...
          <section className="scroll-mt-24">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              ...
              ·{" "}
              <Link to="/blog" className="text-azure-deep underline">
